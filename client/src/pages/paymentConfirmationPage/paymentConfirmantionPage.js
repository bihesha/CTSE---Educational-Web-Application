...
export default function PaymentConfirmationPage() {
    ...
    const { course: fetchedCourse, loading, viewOneCourseById } = useViewCourseById();
    ...
    useEffect(() => {
        ...
        fetchData();
    }, [courseId, user, viewOneCourseById, isUpdated]);
    ...
    }, [fetchedCourse, user, token, navigate, updatePayment, updateEnrollment, courseId, isUpdated, sendEmailToStudent]);
